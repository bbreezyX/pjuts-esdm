...
const workflows = [
  {
    num: "01.",
    title: "Sensus Data Digital",
    desc: "Perekaman identitas setiap unit PJUTS menggunakan QR Code dan koordinat GPS yang akurat untuk pemetaan aset nasional."
  },
  {
    num: "02.",
    title: "Transmisi IoT",
    desc: "Pengiriman data kondisi lampu dan baterai secara berkala melalui jaringan seluler atau satelit ke pusat data Kementerian ESDM."
  },
  {
    num: "03.",
    title: "Verifikasi & Tindak Lanjut",
    desc: "Validasi laporan otomatis oleh sistem, diteruskan kepada penyedia jasa untuk perbaikan segera guna menjaga standar pelayanan."
  }
];
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="flex flex-col md:flex-row justify-between items-end mb-20 gap-12">
          <h2 className="text-5xl md:text-8xl font-bold tracking-tight max-w-3xl leading-[0.9] text-white">
            Alur Kerja <br />
            <span className="text-accent">Monitoring</span> Terpadu
          </h2>
          <p className="text-white/40 max-w-xs text-sm leading-relaxed font-medium">
            Sistem kami memastikan setiap rupiah investasi negara dalam PJUTS terpantau manfaatnya secara maksimal bagi masyarakat.
          </p>
        </div>
          ...
          {workflows.map((item, i) => (
            ...
            >
              <div className="flex justify-between items-center mb-16">
                <span className="text-3xl font-bold text-accent/40 group-hover:text-accent transition-colors">{item.num}</span>
